export const APP_DB_MIGRATIONS: readonly string[] = [
  ...
  `CREATE TABLE IF NOT EXISTS book_snapshot (
    ...
    sophia_library_status TEXT NOT NULL DEFAULT 'unknown',
    utokyo_library_status TEXT NOT NULL DEFAULT 'unknown',
    sophia_opac_url TEXT NOT NULL DEFAULT '',
    utokyo_opac_url TEXT NOT NULL DEFAULT '',
    wish_rowid INTEGER,
